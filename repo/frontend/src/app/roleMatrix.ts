...
export const navItems: NavItem[] = [
  ...
  { label: 'Booking', path: '/booking', icon: 'booking', roles: ['traveler', 'admin'] },
  ...
  { label: 'Role Audits', path: '/role-audits', icon: 'audits', roles: ['operations', 'admin'] },
  { label: 'Admin', path: '/admin', icon: 'admin', roles: ['operations', 'admin'] },
  { label: 'API Docs', path: '/docs', icon: 'docs', roles: ['operations', 'admin'] }
];
